 ...
 *
 * Tables are added per phase (see docs/mvp-scope.md):
 *   Phase 2   – skills, skill_evidence, approvals, agent_runs, agent_events
 *   Phase 2.5 – activity_events, activity_analyses, ingest_tokens
 *   Phase 3   – learning_sessions, dsa_patterns, dsa_problems, dsa_attempts, ai_usage, llm_cache, agent_model_config
